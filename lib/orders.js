...
async function setRentalWindow(ref, patch) {
  ...
  if (!current) return false;
  const set = {};
  if (patch && patch.end_date !== undefined) set.end_date = patch.end_date;
  if (patch && patch.days !== undefined) set.days = patch.days;
  if (patch && patch.amount_due !== undefined) set.amount_due = patch.amount_due;
...
module.exports = {
  ...
  repairPurchase, setRentalWindow
};
