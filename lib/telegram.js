...
// message to someone who messaged the Page in the last 24 hours, so an owner
// alert on that channel goes silent after a quiet day — exactly when the
// owner is away and needs it. Telegram has no such window.
//
